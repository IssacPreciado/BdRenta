...
using BdRenta.Client.Pages;
using BdRenta.Components;
using BdRenta.Repositorio;
...
builder.Services.AddScoped<IRepositorioAutomoviles, RepositorioAutomoviles>();
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(BdRenta.Client._Imports).Assembly);
